...
/* User Configuration */
// Timer Clock
#define TIMER_CLOCK				84000000	// 84MHz(TIM3)

// MOTOR 1 (PA3) - TIM3 Channel 1, DMA1 Stream 4
#define MOTOR_1_TIM             (&htim3)
#define MOTOR_1_TIM_CHANNEL     TIM_CHANNEL_1

// MOTOR 2 (PA2) - TIM3 Channel 2, DMA1 Stream 5
#define MOTOR_2_TIM             (&htim3)
#define MOTOR_2_TIM_CHANNEL     TIM_CHANNEL_2

// MOTOR 3 (PA0) - TIM3 Channel 3, DMA1 Stream 7
#define MOTOR_3_TIM             (&htim3)
#define MOTOR_3_TIM_CHANNEL     TIM_CHANNEL_3

// MOTOR 4 (PA1) - TIM3 Channel 4, DMA1 Stream 2
